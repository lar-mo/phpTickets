...
function MakeCalendar($sDateArg,$iSizeArg="",$sColorArg="") {
	...
	if (($iThisMonth - 1) > '0') { $iThisMonth2 = $iThisMonth - 1; $iThisYear2 = $iThisYear; } else { $iThisMonth2 = 12; $iThisYear2 = $iThisYear - 1; };
	print "<a href=\"?m=$iThisMonth2&y=$iThisYear2\"><</a>"; 

					print " | <b> $sThisMonthName ($iThisYear)</b> | "; 

	if (($iThisMonth + 1) < '13') { $iThisMonth3 = $iThisMonth + 1; $iThisYear2 = $iThisYear; } else { $iThisMonth3 = 1; $iThisYear2 = $iThisYear + 1; };
	print "<a href=\"?m=$iThisMonth3&y=$iThisYear2\">></a>"; 
	print "</td></tr>";
