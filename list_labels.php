...
<body onLoad=\"print();\" bgcolor=\"#FFFFFF\" text=\"#000000\" link=\"#000000\" alink=\"#000000\" vlink=\"#000000\" marginwidth=0 marginheight=0 leftmargin=0 rightmargin=0 topmargin=0 bottommargin=10>
<CENTER>";
...
$sqlquery = "SELECT * FROM personnel WHERE emp_title <> 'group' AND emp_title <> 'none'";
...
//	print "<img src=\"./images/all_groups_logo1.jpg\" />";

	} elseif (strlen($group) < '1') {

//	print "<img src=\"./images/personnel_big_logo1.jpg\" />";

	} else {

//	print "<table><tr><td align=\"right\" valign=\"bottom\"><img src=\"./images/members_of_logo1.jpg\" /></td><td align=\"center\" valign=\"bottom\">&nbsp;<b><i>$group</i></b>&nbsp;</td><td align=\"left\" valign=\"bottom\"><img src=\"./images/group_logo1.jpg\" /></td></tr></table>";
...
<tr>
	...
	<th><font size=\"-1\" color=\"#000000\">Login</font></th>
...
print "
<table border=0 width=\"612\" cellspacing=0 cellpadding=0><tr>
";
...
/* 
print "
	<td align=\"center\" bgcolor=\"#FFFFFF\"><font size=\"-1\"><a href=\"show.php?type=personnel&id=$theemp_id\">$theemp_id</a></font></td>
     	...
     	<td align=\"center\" bgcolor=\"#FFFFFF\"><font size=\"-1\">"; if(strlen($theemp_email) < '1') { print "&nbsp;"; } else { print "<a href=mailto:$theemp_email>$theemp_email</a>"; } print "</font></td>
...
print "
     	<td height=\"79\" width=\"204\" align=\"left\" bgcolor=\"#FFFFFF\"><font face=\"comic sans ms\" color=\"#000000\">$theemp_name<br>$theemp_address</font></td>";
...
if ($view == 'ALL') {
 ...
 $sqlquery = "SELECT proj_id, proj_name, proj_submitter, proj_assignee, date_format(proj_create_dt, '%c/%e/%y %l:%i:%s %p') as proj_create_dt, proj_status, proj_type, proj_priority, proj_desc, proj_notes, proj_due_dt FROM projects WHERE proj_status = 'OPEN' OR proj_status = 'ASSIGNED' OR proj_status = 'PENDING' ORDER BY proj_id DESC";
 ...
 $sqlquery = "SELECT proj_id, proj_name, proj_submitter, proj_assignee, date_format(proj_create_dt, '%c/%e/%y %l:%i:%s %p') as proj_create_dt, proj_status, proj_type, proj_priority, proj_desc, proj_notes, proj_due_dt FROM projects WHERE proj_status = 'OPEN' OR proj_status = 'ASSIGNED' OR proj_status = 'PENDING' ORDER BY proj_due_dt";
 ...
 if (strlen($assignee) > '1') {
  ...
  $sqlquery = "SELECT proj_id, proj_name, proj_submitter, proj_assignee, date_format(proj_create_dt, '%c/%e/%y %l:%i:%s %p') as proj_create_dt, proj_status, proj_type, proj_priority, proj_desc, proj_notes, proj_due_dt FROM projects WHERE proj_status = '$view' ORDER BY proj_id DESC";
...
if ($number < 1) {
	...
	if (strlen($view) < '1') {
	print "<center>
<img src=\"./images/projects_logo1.jpg\" />
...
<table border=0 cellpadding=5 width=\"100%\" bgcolor=\"#CCCCCC\"><tr>
 ...
 <tr><td bgcolor=\"#FFFFFF\" colspan=9><CENTER><h4>There are no tickets that are OPEN, ASSIGNED or PENDING.</h4>Click here to <a href=\"insert.php?type=projects\">open a ticket</a>.</CENTER></td></tr>
